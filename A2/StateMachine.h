...
enum MachineState {
  ...
  //Relational Operator States
	...
	ENDFILE_STATE, COMMENT_STATE, LINECOMMENT_STATE,HALFENDCOMMENT_STATE, NOT_STATE,LAST_STATE,
    NUM_STATES
};
...
enum CharacterType {
  ...
  //Relational Operator States
	...
	// Other Characters:
	SEMICOLON_CHAR, LPAREN_CHAR, RPAREN_CHAR, LCURLY_CHAR, RCURLY_CHAR, UNDERSCORE_CHAR,EXCLAMATION_CHAR,LAST_CHAR,
	// Other Token Types
    ENDFILE_CHAR,
    NUM_CHARS
};
